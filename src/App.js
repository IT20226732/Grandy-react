...
import ShopPage1 from "./pages/shop/ShopPage1";
import ShopPage2 from "./pages/shop/ShopPage2";
import ShopPage3 from "./pages/shop/ShopPage3";
import ShopPage4 from "./pages/shop/ShopPage4";
import ShopPage5 from "./pages/shop/ShopPage5";
import ShopPage6 from "./pages/shop/ShopPage6";
import ShopPage7 from "./pages/shop/ShopPage7";
import ShopPage8 from "./pages/shop/ShopPage8";
import ShopPage9 from "./pages/shop/ShopPage9";
import PrivacyTerms from './pages/inner/PrivacyPolicie';
import TermsCondition from './pages/inner/TermsCondition';
      ...
      <ScrollIntoView>
        <ScrollToTop>
          <Switch>
            ...
            />
            <Route exact path={`${process.env.PUBLIC_URL}/about-creative`} component={AboutCreativePage} />
            {/* <Route
              exact
            ...
            <Route
              exact
              path={`${process.env.PUBLIC_URL}/shop4`}
              component={ShopPage4}
            />
            <Route
              exact
              path={`${process.env.PUBLIC_URL}/shop5`}
              component={ShopPage5}
            />
            <Route
              exact
              path={`${process.env.PUBLIC_URL}/shop6`}
              component={ShopPage6}
            />
            <Route
              exact
              path={`${process.env.PUBLIC_URL}/shop7`}
              component={ShopPage7}
            />
            <Route
              exact
              path={`${process.env.PUBLIC_URL}/shop8`}
              component={ShopPage8}
            />
            <Route
              exact
              path={`${process.env.PUBLIC_URL}/shop9`}
              component={ShopPage9}
            />
            <Route
              exact
              path={`${process.env.PUBLIC_URL}/privacy-terms`}
