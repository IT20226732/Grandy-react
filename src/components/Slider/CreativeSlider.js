...
import videoMp4 from "../../assets/images/video/video720pd.mp4";
import videoWebm from "../../assets/images/video/video720pd.webm";
        ...
        <div className="hero-text white-color">
          <div className="container">
            <div className="white-color text-center">
              <h1 className="white-color font-700 text-uppercase mb-0">AWS</h1>
              <h1 className="white-color font-700 text-uppercase mt-0">
                Trading
              </h1>
              <h5 className="white-color">
                Your One-Stop Shop for High-Quality Lighting Solutions!
              </h5>
              {/* <p className="text-center mt-30">
                <a
                  href={process.env.PUBLIC_URL}
                  className="btn btn-outline-white btn-md btn-default btn-animate"
                >
                  <span>
