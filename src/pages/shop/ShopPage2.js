...
import dataShop from "../../data/Shop/shop-three-data.json";
// Images
import imgBg from "../../assets/images/slides/colourBg.jpg";
// Components
...
const ShopPage = () => (
  <Loader>
    ...
    <PageTitleTwo
      title="B22-Colour-Bulbs & E27-Colour-Bulbs"
      image={imgBg}
    />
    <section>
      <div className="container">
        ...
        <div className="col-md-12">
              <h3 className="text-uppercase text-left">B22-Colour-Bulbs & E27-Colour-Bulbs</h3>
            </div>
          {dataShop.map((item) => (
