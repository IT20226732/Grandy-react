...
import dataShop from "../../data/Shop/shop-two-data.json";
// Images
import imgBg from "../../assets/images/slides/roundBg.jpg";
// Components
...
const ShopPage = () => {
  ...
  const secondLineData = dataShop.slice(2, 4);

  return (
    <Loader>
      <NavbarCart data={dataNavbar} type="white" />
      <PageTitleTwo
        title="24W-Round & Edge Lights"
        image={imgBg}
      />
      <section>
        <div className="container">
          ...
          <div className="col-md-12">
              <h3 className="text-uppercase text-left">24W-Round & Edge Lights</h3>
            </div>
