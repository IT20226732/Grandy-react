...
import dataShop from "../../data/Shop/shop-four-data.json";
// Images
import imgBg from "../../assets/images/slides/floodBg.jpg";
// Components
...
const ShopPage = () => {
  ...
  const firstLineData = dataShop.slice(0, 6);
  const secondLineData = dataShop.slice(6, 11);

  return (
    <Loader>
      <NavbarCart data={dataNavbar} type="white" />
      <PageTitleTwo
        title="Flood Lights / Panel-Lights"
        image={imgBg}
      />
      <section>
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h3 className="text-uppercase text-left">Flood Lights</h3>
            </div>
          ...
          <div className="row">
            <div className="col-md-12">
              <h3 className="text-uppercase text-left">Panel-light</h3>
            </div>
