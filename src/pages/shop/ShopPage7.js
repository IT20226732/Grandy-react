...
import dataShop from "../../data/Shop/shop-eight-data.json";
// Images
import imgBg from "../../assets/images/slides/swimmingBg.jpg";
// Components
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
            <h3 className="text-uppercase text-left">Swimming-Pool-Lights</h3>
          </div>
