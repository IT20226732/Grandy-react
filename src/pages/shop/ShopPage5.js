...
import dataShop from "../../data/Shop/shop-six-data.json";
// Images
import imgBg from "../../assets/images/slides/shadersBg.jpg";
// Components
...
const ShopPage = () => {
  ...
  const secondLineData = dataShop.slice(2, 3);

  return (
    <Loader>
      <NavbarCart data={dataNavbar} type="white" />
      <PageTitleTwo
        title="Shader Lights / Shader Lights (Crystal)"
        image={imgBg}
      />
      <section>
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h3 className="text-uppercase text-left">Shader Lights</h3>
            </div>
          ...
          <div className="row">
            <div className="col-md-12">
              <h3 className="text-uppercase text-left">Shader Light Crystal</h3>
            </div>
