...
import dataShop from "../../data/Shop/shop-seven-data.json";
// Images
import imgBg from "../../assets/images/slides/streetBg.jpg";
// Components
...
const ShopPage = () => {
  ...
  const firstLineData = dataShop.slice(0, 3);
  const secondLineData = dataShop.slice(3, 8);

  return (
    <Loader>
      <NavbarCart data={dataNavbar} type="white" />
      <PageTitleTwo
        title="Street Lights / Track Lights"
        image={imgBg}
      />
      <section>
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h3 className="text-uppercase text-left">Street Lights</h3>
            </div>
          ...
          <div className="row">
            <div className="col-md-12">
              <h3 className="text-uppercase text-left">Track Lights</h3>
            </div>
